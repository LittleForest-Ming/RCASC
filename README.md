...
# Pretrained model
Download the pretrained model from the [Netdisk](https://pan.baidu.com/s/1J4FrBJ6BiLjIZFpGrim_dg?pwd=6gbf) .or Considering that the software is not general-purpose and is slow, contact (quanlongzhe@163.com) the corresponding author for direct mail transfer. 
